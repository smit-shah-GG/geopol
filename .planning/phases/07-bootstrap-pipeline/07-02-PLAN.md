...
```
  ...
  <done>
ConsoleReporter outputs [STAGE] formatted messages, and `should_skip_stage` correctly refuses to skip when output validation fails.
  </done>
</task>
...
- ConsoleReporter outputs progress in [STAGE] format
